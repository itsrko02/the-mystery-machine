        ...
        <div class="intro-body">
            <div class="container">
				<div class="row">
					...
					<div class="row">
					<div class="col-lg-12">
					<img class="img-responsive" src="img/458.jpg" style="border-radius:25px;padding:0px;">
					<div style="position:absolute;top:77%;left:18%">
					<audio controls>
					...
					<br/>
					<audio controls>
						<source src="mp3/458n.mp3" type="audio/mpeg">
							Your browser does not support the audio element.
					</audio>
					</div>
					</div>
					...
					<?php
					$hint=0;
					$result=mysqli_query($conn,"SELECT * from hints where level='5' order by hintn");
					if($result)
