        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="http://www.roboticsclub.mmmut.ac.in" target="_blank">
                    <span class="light">TESLA</span> | ELECTRA
                </a>
            </div>
	...
	<header class="intro">
        <div class="intro-body">
            <div class="container">
				<div class="row">
					...
					<div class="row">
					<div class="col-lg-12">
					<img class="img-responsive" src="img/145.jpg" style="border-radius:25px;padding:0px;">
					</div>
					</div>
					<br/>
					<div class="row">
	 ...
	 <footer>
        <div class="container text-center">
            <p>Copyright &copy; ELECTRA 2018</p>
        </div>
    </footer>
