...
<head>
	...
	<title>The Mystery machine | Ennexus</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="leaderboard.php" target="_blank"><span class="glyphicon glyphicon-menu-hamburger"></span> Leaderboard</a>
                    </li>
                    <li>
        ...
        <div class="intro-body">
            <div class="container">
				<div class="row">
					...
					<div class="row">
					<div class="col-lg-12">
					<img class="img-responsive" src="img/01.jpg" style="border-radius:25px;padding:0px;">
					</div>
					</div>
					<br/>
					<div class="row">
					...
					<?php
					$hint=0;
					$result=mysqli_query($conn,"SELECT * from hints where level='1' order by hintn");
					if($result)
