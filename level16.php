        ...
        <div class="intro-body">
            <div class="container">
				<div class="row">
					...
					<div class="row">
					<div class="col-lg-12">
					<img class="img-responsive" src="img/16.jpg" style="border-radius:25px;padding:0px;">
					<div style="position:absolute;top:82%;left:32%">
					...
					<?php
					$hint=0;
					$result=mysqli_query($conn,"SELECT * from hints where level='16' order by hintn");
					if($result)
